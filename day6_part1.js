 ...
 * 5. If the instruction is to "toggle", iterate over the rows and cols specified and toggle lights that are on to off and vice versa
 * 6. If the instruction is "turn" and "on/off", iterate over the rows and cols specified and turn on/off each light on and off
 * 7. Make a lights_on variable to count how many lights are on after all the instructions are finished
